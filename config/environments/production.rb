# coding: utf-8
Miclle::Application.configure do
  ...
  # config.assets.prefix = '' #set it to empty string

  # Precompile additional assets.
  # application.js, application.css, and all non-JS/CSS in app/assets folder are already added.
  # config.assets.precompile += %w( search.js )
  config.assets.precompile += %w(application.js cpanel.js devise.js photos.js upload.js application.css cpanel.css devise.css)
